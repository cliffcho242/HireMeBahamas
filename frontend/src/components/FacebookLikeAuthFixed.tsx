          ...
          >
            <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-white/30">
              <div className="text-center mb-8">
                <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-teal-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                {!isLogin && (
                  ...
                  >
                    <div className="relative">
                      <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-cyan-400 h-5 w-5" />
                      <input
                        type="text"
                        name="first_name"
                        ...
                        className="w-full pl-10 pr-4 py-3 border-2 border-cyan-100 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all bg-gradient-to-r from-cyan-50/50 to-teal-50/50 placeholder-gray-500"
                        required={!isLogin}
                      />
                    </div>
                    <div className="relative">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full pl-10 pr-12 py-3 border-2 border-cyan-100 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all bg-gradient-to-r from-cyan-50/50 to-teal-50/50 placeholder-gray-500"
                    required
                  />
                  <button
                    type="button"
                ...
                {!isLogin && (
                  ...
                  >
                    <div className="grid grid-cols-1 gap-4">
                      <div className="relative">
                        ...
                        <input
                          type="text"
                          name="location"
                          placeholder="Location (e.g., Nassau, Bahamas)"
                      ...
                      <div className="relative">
                        <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 text-cyan-400 h-5 w-5" />
                        <input
                          type="tel"
                          name="phone"
                    ...
                    <div className="space-y-3">
                      <label className="text-sm font-medium text-gray-700">I am looking to:</label>
