...
from app.core.upload import (
    upload_image, upload_multiple_files, save_file_locally,
    upload_to_cloudinary, delete_file, ALLOWED_IMAGE_TYPES
)
...
async def delete_portfolio_image(
    ...
    if not current_user.portfolio_images or file_url not in current_user.portfolio_images:
        raise HTTPException(
            status_code=404,
