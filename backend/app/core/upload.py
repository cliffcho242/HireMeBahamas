...
def resize_image(image_content: bytes, max_width: int = 800, max_height: int = 600) -> bytes:
...
async def upload_image(file: UploadFile, folder: str = "general", resize: bool = True) -> str:
...
async def upload_multiple_files(files: List[UploadFile], folder: str = "general") -> List[str]:
