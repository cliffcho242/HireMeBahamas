...
def main():
    ...
    backend_health_ok = test_url('http://127.0.0.1:8008/health') if backend_port_ok else False
    ...
    frontend_health_ok = test_url('http://localhost:3000') if frontend_port_ok else False
