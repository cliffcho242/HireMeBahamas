...
def main():
    ...
    users_checks = [
        ...
        ("Username format validation", re.compile(r"re\.match\(r'\^")),
        ("Positive ID validation", "if user_id <= 0"),
        ("Int32 overflow check", "user_id > 2147483647"),
    ...
    frontend_checks = [
        ...
        ("Auto-redirect comment", "Auto-redirect to users page after 3 seconds"),
        ("Countdown timer setup", "setInterval"),
        ("Countdown decrement", "return prev - 1"),
        ("Navigate to friends", "navigate('/friends')"),
