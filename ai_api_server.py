...
from advanced_ai_orchestrator import get_ai_orchestrator, initialize_ai_system, AIConfig
...
async def ai_chat():
    ...
    try:
        ...
        response_text = "I'm sorry, but the AI chat service is not available at the moment."
        ...
        if orchestrator.openai_available:
            ...
            response = await openai.ChatCompletion.acreate(
                model="gpt-4",
                messages=[
                    {"role": "system", "content": "You are HireBot, an AI assistant for HireBahamas job platform. Help users with career advice, job searching, and professional development."},
